...
how to declare that a particular function is a transition from one declared state to another %TODO: FillMe

\subsection{Using The Yeager Connectedness Tester}
how to check that yeager can see your states and transitions %TODO: FillMe

\section{Yeager Test Harnesses}
in more advanced scenarios, we need to assist Yeager's execution %TODO: FillMe

\subsection{Application Configuration}
where to put data yeager always needs %TODO: FillMe

\subsection{Test Setup and Entry Point}
pulling a LSRT run up by its bootstraps, and what point on the graph the test starts at. %TODO: FillMe
